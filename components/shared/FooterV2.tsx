    ...
    <footer className="w-full overflow-hidden">
      ...
      <div className="-mt-10 bg-backgroundBody py-4 dark:bg-dark sm:-mt-[70px] md:-mt-24 xl:-mt-28">
        <div className="container">
          ...
          <div className="relative z-10 flex flex-col flex-wrap justify-center gap-y-10 pt-10 sm:flex-row sm:justify-between sm:gap-y-16 md:pt-20">
            ...
            <div className="pr-8 max-lg:basis-full">
              <p className="mb-5 max-w-[360px]">
                FloCreativeLab delivers world-class post production, VFX, and video editing for commercials, music
                videos, and branded content that captivates audiences.
              </p>
          ...
          <p className="mt-10 border-t pt-5 text-center text-sm dark:border-dark">
            All rights Reserved FloCreativeLab &copy; {new Date().getFullYear()}{' '}
            <Link target="_blank" href="https://www.starprince.dev">
              starprince.dev
            </Link>
          </p>
        </div>
