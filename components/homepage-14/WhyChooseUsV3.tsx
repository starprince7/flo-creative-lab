      ...
      <div className="container">
        <div className="mb-8 text-center md:mb-14">
          <RevealWrapper className="rv-badge">
            <span className="rv-badge-text">Why Choose FloCreative Lab</span>
          </RevealWrapper>
          <TextAppearAnimation>
          ...
          <TextAppearAnimation>
            <p className="text-appear">Great music deserves visuals that amplify its power.</p>
          </TextAppearAnimation>
        </div>
        <article>
          <RevealWrapper className="mb-[30px] flex flex-col gap-[30px] max-lg:flex-wrap md:flex-row">
            <div className="flex-1 border px-[30px] py-10 dark:border-dark">
              ...
              <p>
                We work closely with artists to understand their vision, musical identity, and the story they want to
                tell. Your artistic voice guides our creative direction.
              </p>
            </div>
            <div className="flex-1 border px-[30px] py-10 dark:border-dark">
              <span>
              ...
              <h5 className="mb-2.5 mt-5">Visual Storytelling</h5>
              <p>
                Whether narrative-driven, performance-based, or abstract experimentation, we develop concepts that
            ...
            <div className="flex-1 border px-[30px] py-10 dark:border-dark">
              ...
              <h5 className="mb-2.5 mt-5">Cinematic Execution</h5>
              <p>
                Our team handles everything from editorial pacing and dynamic cutting to advanced VFX, color grading,
                and stylistic treatments that make your video stand out.
              </p>
            </div>
          </RevealWrapper>
          <RevealWrapper className="flex flex-col gap-[30px] md:flex-row">
            <RevealWrapper className="min-h-[322px] flex-1 border px-[30px] py-20 dark:border-dark">
              ...
              <h5 className="mb-2.5 mt-5">Platform Optimization</h5>
              <p>
                Delivered in formats optimized for YouTube, streaming platforms, social media, and broadcast—ensuring
                maximum impact wherever your audience discovers it.
              </p>
            </RevealWrapper>
            <RevealWrapper className="min-h-[322px] flex-1 border px-[30px] py-20 dark:border-dark">
              <span>
